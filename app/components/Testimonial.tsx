...
export function Testimonial() {
    ...
    return(
        ...
        <div className="flex flex-col items-center justify-center">
          <h1 className="text-[#101828] text-[49px] leading-[68.6px] font-bold text-center">
        ...
        <div className="pt-10 overflow-hidden max-w-[1240px] mx-auto">
          ...
          <div className="flex gap-10 items-center justify-start animate-scroll">
            ...
            <div className="max-w-[500px] min-w-[300px] lg:max-w-[500px] rounded-[20px] bg-[#FFFFFF] px-[20px] shadow-custom-black py-[40px] mx-4">
              <div className="flex flex-col items-center justify-center">
                <p className="text-[#101828] text-[16.5px] leading-[23.1px] font-normal max-w-[390.66px]">
                  Consultia has transformed how we manage our clients and projects. It&apos;s a game-changer for our firm, streamlining our processes, improving efficiency, and enabling us to focus more on delivering exceptional results to our clients.
                </p>
              </div>
